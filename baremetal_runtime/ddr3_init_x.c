...
/*
	All content in this file is 'semi-hardcoded' version of u-boot DDR3L init
	including PHY setup and DDR PLL setup
...
//#define DBG	uart_putf("%s:%s:%s\n"__FILE__,__FUNCTION__,__LINE__)
#define DBG(X)	uart_putf("DEBUG%i\n",(X))
...
#define writel(V,A)	*(uint32_t*)(A) = (uint32_t)(V)
